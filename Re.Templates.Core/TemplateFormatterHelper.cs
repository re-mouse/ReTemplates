...
public static class TemplateFormatterHelper
{
    ...
    public static int IndexOfPathConditionClosingTag(MatchCollection tagsMatch, string conditionName, int startIndex)
    {
        return tagsMatch.IndexOf(match =>
        {
            string tag = match.Groups[0].Value;
    ...
    public static int IndexOfPathArrayClosingTag(MatchCollection tagsMatch, string arrayName, int startIndex)
    {
        return tagsMatch.IndexOf(match =>
        {
            string tag = match.Groups[0].Value;
